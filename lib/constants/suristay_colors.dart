...
class SuriStayColors {
  // Primary Brand Colors - RESTORED TO ORIGINAL DARK THEME
  /// Deep Dark Blue - Primary brand color (restored from original)
  static const Color darkGreen = Color(0xFF1a1a2e);
  
  /// Dark Navy Blue - Secondary accent color (restored from original)
  static const Color vibrantRed = Color(0xFF16213e);
  
  /// Accent Blue - Tertiary accent color (restored from original)
  static const Color brightYellow = Color(0xFF0f3460);
  
  // Secondary Colors
  /// Teal Accent - For highlights and interactive elements
  static const Color turquoise = Color(0xFF009688);
