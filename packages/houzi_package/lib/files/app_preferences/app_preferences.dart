...
class AppThemePreferences{
  ...
  static Color appPrimaryColor = Color(0xFF006633); // SuriStay Dark Green
  ///
  /// Secondary Color of App:
  static Color appSecondaryColor = SuriStayColors.vibrantRed;
  ///
  ...
  static Color ratingWidgetStarsColor = SuriStayColors.brightYellow;
  ///
  /// Favourite Icon color
  static Color favouriteIconColor = SuriStayColors.vibrantRed;
  ///
  /// Filled Button Icon color
  static Color filledButtonIconColor = Colors.white;
  ///
  /// Email Button Background color - Using SuriStay Deep Teal
  static Color emailButtonBackgroundColor = Color(0xFF1B3A4B);
  ///
  /// Call Button Background color - Using SuriStay Dark Green
  static Color callButtonBackgroundColor = Color(0xFF006633);
  ///
  /// Message Button Background color - Using SuriStay Turquoise
  static Color messageButtonBackgroundColor = Color(0xFF2EC4B6);
  ///
  ...
  static Color risingLeadsColor = SuriStayColors.successGreen;
  ///
  /// Falling Leads Text Font color
  static Color fallingLeadsColor = SuriStayColors.vibrantRed;
  ///
  ...
  static Color? tabBarSelectedLabelColor;
  ///
  /// Tab Bar Unselected Label Color
  static Color? tabBarUnselectedLabelColor;
  ///
  ...
  ///
  /// Action Button Background Color - Using SuriStay Dark Green
  static Color actionButtonBackgroundColor = Color(0xFF006633);
  ///
  /// Form Field Border Color - Using SuriStay Turquoise
  static Color formFieldBorderColor = Color(0xFF2EC4B6);
  ///
  /// AppBar Action Widgets Text Font Color
  static Color appBarActionWidgetsTextFontColor = Colors.white;
  ///
  /// Blog Layout Category Font Color - Using SuriStay Dark Green
  static Color blogLayoutCategoryFontColor = Color(0xFF006633);
  ///
  ...
  ///
  /// Background color
  static Color backgroundColorLight =  SuriStayColors.darkGreen;
  ///
  /// Divider color
  ...
  ///
  /// Background color
  static Color backgroundColorDark =  SuriStayColors.darkGreen;
  ...
  ///
  /// Card color
  static Color cardColorDark =  SuriStayColors.darkGreen.withOpacity(0.12);
...
MaterialColor primaryColorSwatch = UtilityMethods.getMaterialColor("#FF006633"); // Keep as is for now, or update to match darkGreen
MaterialColor secondaryColorSwatch = UtilityMethods.getMaterialColor("#FFE4002B"); // Update to vibrantRed
