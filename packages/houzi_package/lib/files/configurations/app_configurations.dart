...
class AppConfigurations{
  ...
  styleAppConfigIntegration(Map<String, dynamic> configurationsFile){
    ...
    stringValueHolder = UtilityMethods.getStringItemValueFromMap(
      inputMap: configurationsFile,
      key: "tab_bar_selected_label_color",
    );
    if(stringValueHolder != null){
      AppThemePreferences.tabBarSelectedLabelColor = UtilityMethods.getColorFromString(stringValueHolder);
    }

    stringValueHolder = UtilityMethods.getStringItemValueFromMap(
      inputMap: configurationsFile,
      key: "tab_bar_unselected_label_color",
    );
    if(stringValueHolder != null){
      AppThemePreferences.tabBarUnselectedLabelColor = UtilityMethods.getColorFromString(stringValueHolder);
    }
