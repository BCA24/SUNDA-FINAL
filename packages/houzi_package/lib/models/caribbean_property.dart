...
class CaribbeanPropertyData {
  static List<CaribbeanProperty> getAllProperties() {
    return [
      ...
      // Additional Jamaica Properties for Testing
      CaribbeanProperty(
        id: 'JM003',
        title: 'Ocho Rios Beach House',
        description: 'Beautiful 3-bedroom beach house in Ocho Rios with direct beach access and stunning ocean views.',
        price: 750000,
        ...
        bathrooms: 2,
        area: 200,
        images: ['https://example.com/jamaica3.jpg'],
        amenities: ['Beach Access', 'Ocean View', 'Pool', 'Garden', 'Parking'],
        nearBeach: true,
        oceanView: true,
        furnished: true,
        hasPool: true,
        ...
        latitude: 18.4078,
        longitude: -77.1031,
        contactPhone: '+1-876-555-0125',
        contactEmail: 'beachhouse@ochorios.com',
        listedDate: DateTime.now().subtract(const Duration(days: 20)),
      ),

      CaribbeanProperty(
        id: 'JM004',
        title: 'Negril Sunset Villa',
        description: 'Luxury 4-bedroom villa in Negril with infinity pool, sunset views, and private chef service.',
        price: 950000,
        propertyType: 'Villa',
        city: 'Negril',
        country: 'Jamaica',
        ...
        bathrooms: 3,
        area: 300,
        images: ['https://example.com/jamaica4.jpg'],
        amenities: ['Infinity Pool', 'Sunset View', 'Chef Service', 'Garden', 'Parking'],
        nearBeach: true,
        oceanView: true,
        furnished: true,
        hasPool: true,
        ...
        latitude: 18.2677,
        longitude: -78.3489,
        contactPhone: '+1-876-555-0126',
        contactEmail: 'luxury@negrilsunset.com',
        listedDate: DateTime.now().subtract(const Duration(days: 12)),
      ),

      CaribbeanProperty(
        id: 'JM005',
        title: 'Kingston Business Condo',
        description: 'Modern 1-bedroom condo in New Kingston business district, perfect for professionals.',
        price: 120000,
        propertyType: 'Condo',
        city: 'Kingston',
        country: 'Jamaica',
        ...
        bathrooms: 1,
        area: 65,
        images: ['https://example.com/jamaica5.jpg'],
        amenities: ['Business District', 'Security', 'Gym', 'Parking'],
        nearBeach: false,
        oceanView: false,
        furnished: false,
        hasPool: false,
        ...
        latitude: 18.0196,
        longitude: -76.8103,
        contactPhone: '+1-876-555-0127',
        contactEmail: 'business@kingstoncondo.com',
      ...
      CaribbeanProperty(
        ...
        description: 'Sustainable 5-bedroom eco lodge in the Blue Mountains with rainforest views.',
        price: 480000,
        propertyType: 'House',
        city: 'Port Antonio',
        country: 'Jamaica',
        ...
        bathrooms: 4,
        area: 250,
        images: ['https://example.com/jamaica6.jpg'],
        amenities: ['Eco-Friendly', 'Mountain View', 'Rainforest', 'Garden', 'Parking'],
        nearBeach: false,
        oceanView: false,
        furnished: true,
        hasPool: false,
        ...
        latitude: 18.1747,
        longitude: -76.4501,
        contactPhone: '+1-876-555-0128',
        contactEmail: 'eco@portantonio.com',
        listedDate: DateTime.now().subtract(const Duration(days: 35)),
      ),
