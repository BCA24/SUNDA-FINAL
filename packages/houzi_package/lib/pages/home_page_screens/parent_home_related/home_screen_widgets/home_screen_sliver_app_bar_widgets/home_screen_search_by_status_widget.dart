...
class HomeScreenSearchByStatusWidgetState extends State<HomeScreenSearchByStatusWidget> {
  ...
  void loadData() {
    ...
    // If maxAllowed is 0, don't show any filter buttons
    if (maxAllowed <= 0) {
      return;
    }
  ...
  Widget build(BuildContext context) {
    ...
    // Hide the widget if no filter options are available
    if (defaultSearchTypeSwitchOptions <= 0 || labelsList.isEmpty) {
