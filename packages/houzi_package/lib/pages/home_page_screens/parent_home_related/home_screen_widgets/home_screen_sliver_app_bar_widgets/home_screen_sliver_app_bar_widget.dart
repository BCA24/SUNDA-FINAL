...
class _HomeScreenSliverAppBarWidgetState extends State<HomeScreenSliverAppBarWidget> {
  ...
  double extendedHeight = 20.0; // Ultra aggressive minimal height - maximum positioning
  double padding = 10.0;
  ...
  Widget build(BuildContext context) {
    return SliverAppBar(
      ...
      backgroundColor: const Color(0xFF37474F), // Blue-grey to match bottom navigation bar
      pinned: true,
          ...
          LayoutBuilder(
            builder: (BuildContext context, BoxConstraints constraints) {
              ...
              return FlexibleSpaceBar(
                ...
                title: const SizedBox.shrink(), // Remove search bar
                background: Column(
                  children: [
