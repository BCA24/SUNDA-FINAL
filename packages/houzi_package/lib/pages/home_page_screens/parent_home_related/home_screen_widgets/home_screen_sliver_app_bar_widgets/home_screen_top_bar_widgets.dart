...
class _HomeScreenTopBarWidgetState extends State<HomeScreenTopBarWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.only(top: 0.0, left: 20, right: 20), // Zero top padding for maximum height
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        crossAxisAlignment: CrossAxisAlignment.center, // Center vertically
        children: [
          // Empty space to push SUNDA to the right
          Expanded(child: Container()),
          // SUNDA text positioned on the right, vertically centered
          Text(
            'SUNDA',
            style: TextStyle(
              color: Colors.white,
          ...
          SizedBox(width: 20), // Space between SUNDA and notification
