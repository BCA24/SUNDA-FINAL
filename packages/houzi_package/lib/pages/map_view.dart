...
import 'package:houzi_package/widgets/real_caribbean_map.dart';
...
class _MapViewState extends State<MapView> with AutomaticKeepAliveClientMixin<MapView> {
  ...
  bool hideMap = true; // Disabled to prevent Google Maps crashes
          ...
          children: [
            ...
            Listener(
              ...
              child: (hideMap || widget.hideMap) ? 
                // Use real Caribbean map instead of empty container
                RealCaribbeanMap(
                  properties: widget.listArticles,
                  height: double.infinity,
                  onCountrySelected: (country) {
                    if (widget.mapViewListener != null) {
                      widget.mapViewListener!(
                        coordinatesMap: {"country": country},
                        someActivityOnMap: true,
                      );
                    }
                  },
                ) : GoogleMap(
