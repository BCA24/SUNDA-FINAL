...
// Import SuriStay colors for gradient theme
  ...
  Widget build(BuildContext context) {
    return Semantics(
      ...
      child: AnimatedContainer(
        ...
        curve: curve,
        decoration: BoxDecoration(
          // Enhanced selection indicator with Caribbean orange glow
          color: isSelected 
...
class BottomNavyBarItem {
  ...
  BottomNavyBarItem({
    ...
    this.inactiveColor,
  }) : activeColor = activeColor ?? AppThemePreferences.appPrimaryColor;
